...
## Copied from https://github.com/kbase/cdm-jupyterhub/blob/main/src/minio_utils/minio_utils.py
...
def get_minio_client(
    ...
    return Minio(minio_url, access_key=access_key, secret_key=secret_key, secure=secure)
